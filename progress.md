...
## 2026-08-25 - Task: Prepare Android 5.7.7 release
### What was done
- Migrated only the 5.7.7 Android bottom-sheet width correction and version metadata into `codex/android-release`.
- Excluded the iOS branch history, Leanback deletions, screenshots, and debug XML files.

### Testing
- Passed: `.\gradlew.bat :app:assembleMobileArm64_v8aDebug --no-daemon --no-parallel --max-workers=1 --gradle-user-home D:\xingkong\.gradle` completed with `BUILD SUCCESSFUL`.
- Passed: `aapt dump badging` reports package `com.xingguang.video`, `versionCode='577'`, and `versionName='5.7.7'`.
- Passed: `git diff --check` reports no whitespace errors.
- Passed: the Android release branch diff contains no `ios/` paths.
- Artifact: `app/build/outputs/apk/mobileArm64_v8a/debug/mobile-arm64_v8a.apk`, size `82656716` bytes, SHA-256 `2493608EE6849B583CFE089DCCFB7FFA3C6CEC5D6489C4677A55CC0D93BD697E`.
...
## 2026-08-26 - Task: Publish Android 5.7.9
### What was done
- Published GitHub Release `v5.7.9` from the corrected `codex/android-release` branch.
- Kept the formal APK asset `XingGuang-5.7.9-arm64.apk` and marked the release as latest.

### Testing
- Passed: GitHub API reports `draft=false`, tag `v5.7.9`, and target `codex/android-release`.
- Passed: public asset is `82656716` bytes and reports SHA-256 `CF33B923582F11F56A0958587EA8D35E13924B8FB15195D4DC0D400BC6187DA8`.
- Passed: release URL resolves to `https://github.com/aqgyvn/XingGuang-tv/releases/tag/v5.7.9`.
...
## 2026-08-26 - Task: Publish Android 5.7.11
### What was done
- Published GitHub Release `v5.7.11` from the corrected `codex/android-release` branch.
- Kept the formal APK asset `XingGuang-5.7.11-arm64.apk` and marked the release as latest.

### Testing
- Passed: GitHub API reports `draft=false`, tag `v5.7.11`, and target `codex/android-release`.
- Passed: public asset is `82656724` bytes and reports SHA-256 `9771B8C7267E2715631BA33114A182875A546DDCB6574C4035965EABB64351AD`.
- Passed: release URL resolves to `https://github.com/aqgyvn/XingGuang-tv/releases/tag/v5.7.11`.
