...
public class Util {
    ...
    public static final String XGHTTP = OKHTTP;
    ...
    public static String digest(String userInfo, String header, okhttp3.Request request) {
        return digest(userInfo, header, new XgRequest.Builder().url(request.url().toString())
