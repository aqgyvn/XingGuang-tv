...
public class VideoActivity extends BaseActivity implements Clock.Callback, CustomKeyDown.Listener, TrackDialog.Listener, ControlDialog.Listener, FlagAdapter.OnClickListener, EpisodeAdapter.OnClickListener, QualityAdapter.OnClickListener, QuickAdapter.OnClickListener, ParseAdapter.OnClickListener, CastDialog.Listener, InfoDialog.Listener {
    ...
    private void onChoose() {
        PlayerEngineDialog.show(this, mBinding.control.action.player, this::onRefresh);
    }
    ...
    private void setTransition() {
        ...
        transition.addTarget(mBinding.video);
    ...
    private void showControl() {
        ...
        if (!isLock()) setControlTraffic();
        else hideControlTraffic();
        setR1Callback();
    }
    ...
    private void setControlTraffic() {
        if (isLock() || !isVisible(mBinding.control.getRoot())) {
            hideControlTraffic();
            return;
        }
        Traffic.setSpeed(mBinding.control.size);
        App.post(mR5, 1000);
    }

    private void hideControlTraffic() {
        App.removeCallbacks(mR5);
    ...
    private void setTrackVisible() {
        mBinding.control.action.text.setVisibility(mPlayers.get() != null && (mPlayers.haveTrack(C.TRACK_TYPE_TEXT) || mPlayers.isVod()) ? View.VISIBLE : View.GONE);
