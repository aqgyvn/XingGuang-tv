...
public class SettingPlayerFragment extends BaseFragment implements UaCallback, BufferCallback, SpeedCallback {
    ...
    protected void initView() {
        ...
        mBinding.videoPurifyText.setText(getSwitch(Setting.isVideoPurify()));
        mBinding.adHostBlockText.setText(getSwitch(Setting.isAdHostBlock()));
        ...
        PlayerEngineDialog.setText(mBinding.engineText);
    ...
    protected void initEvent() {
        ...
        mBinding.videoPurify.setOnClickListener(this::setVideoPurify);
        mBinding.adHostBlock.setOnClickListener(this::setAdHostBlock);
    ...
    private void onEngine(View view) {
        PlayerEngineDialog.show(requireActivity(), mBinding.engineText, null);
    }
    ...
    private void setVideoPurify(View view) {
        Setting.putVideoPurify(!Setting.isVideoPurify());
        mBinding.videoPurifyText.setText(getSwitch(Setting.isVideoPurify()));
    }

    private void setAdHostBlock(View view) {
        Setting.putAdHostBlock(!Setting.isAdHostBlock());
        mBinding.adHostBlockText.setText(getSwitch(Setting.isAdHostBlock()));
    }
