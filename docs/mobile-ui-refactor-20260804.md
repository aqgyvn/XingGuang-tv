...
- APK `5.7.9 (579)` applies the compact player-engine selector's content width in both portrait and landscape, removing the unused right-side sheet area while leaving track and list dialogs full-width.
