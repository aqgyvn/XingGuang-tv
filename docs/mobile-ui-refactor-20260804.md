...
- APK `5715 (5715)` keeps the landscape player-engine selector at 420dp, explicitly divides its option row into three equal shares, and applies the fullscreen window size before the bottom sheet is first measured.
